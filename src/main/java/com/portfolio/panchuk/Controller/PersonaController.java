...
public class PersonaController {
 ...
 @Autowired
    ...
    public ResponseEntity<?> create(@RequestBody dtoPersona dtopersona) {
        ...
        Persona persona = new Persona(dtopersona.getNombre(), dtopersona.getApellido(), dtopersona.getImg(), dtopersona.getTitulo(), dtopersona.getAcercaDe());
